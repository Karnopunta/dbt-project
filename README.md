# Project ingest data using airflow  
...
There are total 12 container running on this docker-compose. The code can be see [here](Docker/docker-compose.yml)  
...
This is one of the example of the code [here](Docker/dags/category.py)  
Add postgres connection in DAGs script and match it with configuration connection in airflow. 

![image](documentations/connection_in%20airflow.png)
...
![image](documentations/airflow_dashboard.png)
...
![image](documentations/database_ingest.png)
...
or you can see the complete configuration in this [file](dbt-profiles/profiles.yml)  
...
`dbt deps`  
You can see the complete configuration in this [*package.yml* ](dbt_project/packages.yml)
...
You can see the complete configuration in this [*dbt_project.yml* ](dbt_project/dbt_project.yml)
...
You can see the complete configuration in this [*fct_product_age.sql*](dbt_project/models/dbt-fct/fct_product_age.sql)
...
You can see the complete configuration in this [*fct_category_statistic.sql*](dbt_project/models/dbt-fct/fct_category_statistic.sql)
...
You can see the complete configuration in this [*fct_available_stock.sql*](dbt_project/models/dbt-fct/fct_available_stock.sql)
...
You can see the complete configuration in this [*fct_transaction_product.sql*](dbt_project/models/dbt-fct/fct_transaction_product.sql)
...
You can see the complete configuration in this [*fct_time_analysis.sql*](dbt_project/models/dbt-fct/fct_time_analysis.sql)
...
You can see the complete configuration in this [*schema.yml*](dbt_project/models/dbt-fct/schema.yml)

### Running the DBT on airflow

Create DAG script [*dbt.py* ](Docker/dags/dbt.py)  
...
![image](documentations/dbt_logs.png)

and this is the database now:  

![image](documentations/after%20dbt%20run%20in%20database.png)
